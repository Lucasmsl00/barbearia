package br.com.lucaslima.barbearia.config;

import br.com.lucaslima.barbearia.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // públicos: cliente agenda sem login, barbeiro faz login
                        .requestMatchers("/api/auth/**").permitAll()
                        .requestMatchers("/api/barbeiros/registrar").permitAll()
